...
REPO="https://raw.githubusercontent.com/zhets/xdvip/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/zhets/xdvip/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/zhets/xdvip/main/ip | grep $MYIP | awk '{print $3}')
